<form role="search" method="get" class="search-form" id="search-form" action="<?= esc_url( home_url( '/' ) ) ?>">
		...
		<button type="submit" class="search-submit" id="search-submit" aria-label="search-submit">
        ...
        <button type="submit" class="search-close" id="search-close" aria-label="search-close">
